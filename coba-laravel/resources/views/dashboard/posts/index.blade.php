...
<div class="table-responsive col-lg-8">
  {{-- untuk membuat/menabahkan pakae --/--/create --}}
    ...
    <a href="/posts?author={{ auth()->user()->username }}" class="btn btn-info mb-3">Lihat Postingan!</a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            {{-- aturan default dari resource nya, jadi setelah slug-nya itu, dikasi lagi edit --}}
